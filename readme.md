...
использовал по сылке с https://hub.docker.com/_/php
https://www.pascallandau.com/blog/php-php-fpm-and-nginx-on-docker-in-windows-10/
почему то не могу зайти с лок. компьютера в myphpadmin дальше картинки с регистрацией
с linux и телефона норм. а с родного - фиг. С wordpress также было. Оставлю на потом. 
